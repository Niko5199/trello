...
Trello.prototype.delMemberFromCard = function (cardId, memberId, callback) {
  ...
  return makeRequest(
    rest.delete,
    this.uri + "/1/cards/" + cardId + "/members/" + memberId,
    { query: query },
    callback
  );
};
...
Trello.prototype.getActionsOnCard = function (cardId, callback) {
  return makeRequest(
    rest.get,
    this.uri + "/1/cards/" + cardId + "/actions",
    { query: this.createQuery() },
    callback
  );
};
...
Trello.prototype.getListsOnBoard = function (
  boardId,
  fields = "all",
  callback
) {
...
Trello.prototype.addCustomField = function (boardId, name, callback) {
  ...
  return makeRequest(
    rest.post,
    this.uri + "/1/customFields",
    { data: data, query: query },
    callback
  );
};

Trello.prototype.addOptionToCustomField = function (
  customField,
  value,
  callback
) {
  ...
  return makeRequest(
    rest.post,
    this.uri + "/1/customFields/" + customField + "/options",
    { data: data, query: query },
    callback
  );
};

Trello.prototype.setCustomFieldOnCard = function (
  cardId,
  customField,
  value,
  callback
  ...
  return makeRequest(
    rest.put,
    this.uri + "/1/card/" + cardId + "/customField/" + customField + "/item",
...
Trello.prototype.updateCustomFieldOnCard = function (
  cardId,
  field,
  value,
  callback
  ...
  return makeRequest(
    rest.put,
    this.uri + "/1/cards/" + cardId + "/customField/" + field + "/item",
    options,
    callback
  );
};
...
Trello.prototype.getCustomFieldsOnCard = function (cardId, callback) {
  return makeRequest(
    rest.get,
    this.uri + "/1/cards/" + cardId + "/customFieldItems",
    { query: this.createQuery() },
    callback
  );
};
